...
impl EspNowSender {
    ...
    fn add_peer(&self, peer_mac: &MacAddress) -> Result<(), EspNowError> {
        ...
        let peer_info = PeerInfo {
            ...
            channel: Some(0),
            ifidx: esp_idf_svc::wifi::WifiDeviceId::Sta,
        };
    ...
    /// データを送信
    pub fn send(&self, data: &[u8], timeout_ms: u32) -> Result<(), EspNowError> {
    ...
    pub fn send_hash_frame(
        ...
        let hash_data = format!("HASH:{},VOLT:{},{}", hash, voltage_percentage, timestamp);
